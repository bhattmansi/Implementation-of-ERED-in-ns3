 ...
 *
 * Authors: Mansi Bhatt <mansibhatt94@gmail.com>
...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("queueDiscType", "Set Queue disc type to RED or ERED", queueDiscType);
  ...
  if ((queueDiscType != "RED") && (queueDiscType != "ERED"))
    {
      std::cout << "Invalid queue disc type: Use --queueDiscType=RED or --queueDiscType=ERED" << std::endl;
      exit (1);
    }
  ...
  if (queueDiscType == "ERED")
    {
      // Turn on ERED
      Config::SetDefault ("ns3::RedQueueDisc::ERED", BooleanValue (true));
    }
